...
3. Each of the functions add, subtract, multiply, and divide invokes the
funciton print_result, which prints the result of the arithmetic operation.
*/
...
void print_result(float r) { printf("The result is: %f\n", r); }
